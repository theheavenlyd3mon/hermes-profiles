...
name: unbroker
description: >-
  Autonomously remove your info from data-broker sites. Covers install, setup,
  consent intake, autonomous execution loops, email/draft/browser modes, and
  cleanup verification. Triggers: "unbroker", "remove my data from data brokers",
  "opt me out of people search", "data broker removal", "doxxing cleanup",
  "ccpa gdpr opt-out agent".
version: 1.0.0
