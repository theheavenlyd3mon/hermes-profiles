...
- Writing net-new plot "fixes" instead of quote + concrete rewrite suggestion
- Skipping Pass 3 because Pass 2 failed — still run stability once prose is judgeable; blockers can stack
- Leaving handoff only in chat — always write `reviews/{scene_id}.pass{N}.json` for durable loops
