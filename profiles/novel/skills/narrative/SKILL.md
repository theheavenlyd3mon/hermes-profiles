...
### Init
1. Scaffold `manuscript/{project}/` from `templates/` (or `book-pipeline` templates — same fields).
...
- Self-review at book scale (stability trap doubles)
- Ledger drift / voice drift across chapters
- Dumping full manuscript into a 16K–32K context
- Expanding a skill test into a pipeline without being asked
