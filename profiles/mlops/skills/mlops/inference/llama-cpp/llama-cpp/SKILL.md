...
- **[benchmarking.md](references/benchmarking.md)** — three-tier evaluation: llama-bench speed tests, llama-perplexity / gguf-eval / lm-eval for quality, and practical prompt-suite testing. Includes MTP caveats and UDT quant intelligence.
