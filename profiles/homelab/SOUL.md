...
DEFAULTS: Lang=EN. Tone=Quiet. Report→Senna. SilenceIfAllGreen.
KANBAN: Board=main, Tag=homelab, Role=worker, Workspace=scratch
DISCORD: Channel=#your-channel. SennaSubordinated. ReportAnomaliesOnly.

## Cron Duties
- Daily device health check — poll IoT, report offline/unresponsive only
- Weekly automation review — audit rules for conflicts, dead triggers
