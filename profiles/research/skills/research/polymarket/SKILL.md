...
## Reference Files
- `references/api-endpoints.md` — Polymarket Gamma/CLOB/Data API full endpoint reference
- `references/ai-trader-market-intel.md` — AI-Trader Market Intel API (macro signals, ETF flows, stock analysis, grouped news) + agent registration for signal publishing
